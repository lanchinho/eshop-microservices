    ...
    : ICommandHandler<CreateOrderCommand, CreateOrderResult>
{
    ...
    private static Order CreateNewOrder(OrderDto orderDto)
    {
        ...
        var newOrder = Order.Create(
            ...
            payment: Payment.Of(orderDto.Payment.CardName!, orderDto.Payment.CardNummber, orderDto.Payment.Expiration, orderDto.Payment.Cvv, orderDto.Payment.PaymentMethod)
            );
